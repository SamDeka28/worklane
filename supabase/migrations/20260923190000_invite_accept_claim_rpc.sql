-- Invite preview / accept / claim without service-role (user JWT via SECURITY DEFINER).
...
revoke all on function public.claim_my_organization_invitations() from public;
grant execute on function public.claim_my_organization_invitations() to authenticated;
