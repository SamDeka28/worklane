...
const RESOURCE_LINKS = [
  ...
  { href: "/docs/roles-and-access", label: "Roles & access" },
...
const FOOTER_COLUMNS = [
  ...
  { title: "Modules", links: MODULE_LINKS },
  ...
  return (
    <div data-theme="dark" className="lane-marketing lane-auth min-h-svh text-foreground">
      ...
      <footer className="border-t border-white/8 px-5 py-14 sm:px-8 lg:px-12">
        <div className="mx-auto grid max-w-[90rem] gap-12 sm:grid-cols-2 md:grid-cols-[minmax(0,1.5fr)_repeat(4,minmax(0,1fr))] md:gap-10">
