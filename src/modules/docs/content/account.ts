    ...
    blocks: [
      ...
      },
      {
        ...
        rows: [
          ...
          ["Dark Modern", "Neutral graphite, editor classic"],
          ["GitHub Dark / GitHub Light", "Familiar GitHub palettes"],
          ["One Dark", "Atom's balanced slate"],
          ["Dracula", "Purple haze, neon accents"],
          ["Nord", "Arctic, north-bluish calm"],
          ["Monokai", "Warm charcoal, electric color"],
          ["Solarized Dark / Light", "Precision palettes for low light or daylight"],
        ],
      },
      {
        type: "callout",
